...
LANG = {
    ...
    "Marathi": {"title": "Bharat Kisan NOTEBOOK", "new": "Navin Pik Joda", "cat": "Prakar", "crop": "Pik Nivda", "custom": "Tumche Pik Naav Liha", "area": "Kshetra (Guntha)", "bhav": "Bazaar Bhav Rs/Q", "kharch": "Sarva Kharch Prati Acre", "beej": "Beej", "khat": "Khat", "aushad": "Aushad", "majdoor": "Majur", "pani": "Pani", "other": "Itar", "weight": "Ekun Utpadan", "gram": "Gram", "kg": "Kilo", "quintal": "Quintal", "ton": "Ton", "profit": "Nivval Nafa", "total_cost": "Ekun Kharch", "total_income": "Ekun Utpanna", "save": "Jatan Kara", "pages": "Majhi Pane", "weather": "Hawaman v Bazaar", "loan": "Karj Calculator", "edit": "Badal Kara", "delete": "Hatva", "download": "CSV Download"},
    "Hindi": {"title": "Bharat Kisan NOTEBOOK", "new": "Nayi Fasal Jode", "cat": "Shreni", "crop": "Fasal Chune", "custom": "Apni Fasal Ka Naam Likhe", "area": "Kshetra (Guntha)", "bhav": "Bazaar Bhav Rs/Q", "kharch": "Sabhi Kharch Prati Acre", "beej": "Beej", "khat": "Khad", "aushad": "Dawa", "majdoor": "Majdoor", "pani": "Pani", "other": "Anya", "weight": "Kul Upaj", "gram": "Gram", "kg": "Kilo", "quintal": "Quintal", "ton": "Ton", "profit": "Shuddh Labh", "total_cost": "Kul Kharch", "total_income": "Kul Aamdani", "save": "Save Kare", "pages": "Mere Page", "weather": "Mausam v Mandi", "loan": "Loan Calculator", "edit": "Badle", "delete": "Hataye", "download": "CSV Download"}
}

lang = st.sidebar.selectbox("Language / Bhasha", list(LANG.keys()), index=1)
T = LANG[lang]

CAT_TRANS = {
    "English": ["All", "Vegetable", "Fruit", "Kharif", "Rabi", "Other"],
    "Marathi": ["Sarva", "Bhajipala", "Fale", "Kharip", "Rabbi", "Itar"],
    "Hindi": ["Sabhi", "Sabji", "Fal", "Kharif", "Rabi", "Anya"]
}
CAT_MAP = {"Sarva":"All", "Bhajipala":"Vegetable", "Fale":"Fruit", "Kharip":"Kharif", "Rabbi":"Rabi", "Itar":"Other", "Sabhi":"All", "Sabji":"Vegetable", "Fal":"Fruit", "Anya":"Other"}

CROPS_DB = {
    "Tomato": {"cat": "Vegetable", "mr": "Tomato", "hi": "Tamatar", "yield": 150, "beej": 5000, "khat": 8000, "aushad": 7000, "majdoor": 10000, "pani": 3000, "other": 2000},
    "Onion": {"cat": "Vegetable", "mr": "Kanda", "hi": "Pyaj", "yield": 100, "beej": 6000, "khat": 7000, "aushad": 5000, "majdoor": 8000, "pani": 2500, "other": 1500},
    "Dalimb": {"cat": "Fruit", "mr": "Dalimb", "hi": "Anar", "yield": 60, "beej": 15000, "khat": 15000, "aushad": 12000, "majdoor": 10000, "pani": 5000, "other": 3000},
    "Grapes": {"cat": "Fruit", "mr": "Draksh", "hi": "Angur", "yield": 100, "beej": 20000, "khat": 20000, "aushad": 15000, "majdoor": 15000, "pani": 6000, "other": 4000},
    "Banana": {"cat": "Fruit", "mr": "Keli", "hi": "Kela", "yield": 250, "beej": 12000, "khat": 12000, "aushad": 8000, "majdoor": 15000, "pani": 5000, "other": 3000},
    "Mango": {"cat": "Fruit", "mr": "Amba", "hi": "Aam", "yield": 80, "beej": 10000, "khat": 8000, "aushad": 6000, "majdoor": 12000, "pani": 4000, "other": 2000},
    "Orange": {"cat": "Fruit", "mr": "Santra", "hi": "Santra", "yield": 90, "beej": 12000, "khat": 10000, "aushad": 8000, "majdoor": 10000, "pani": 4000, "other": 2000},
    "Guava": {"cat": "Fruit", "mr": "Peru", "hi": "Amrud", "yield": 70, "beej": 8000, "khat": 7000, "aushad": 5000, "majdoor": 8000, "pani": 3000, "other": 1500},
    "Papaya": {"cat": "Fruit", "mr": "Papai", "hi": "Papita", "yield": 120, "beej": 6000, "khat": 6000, "aushad": 5000, "majdoor": 7000, "pani": 3000, "other": 1500},
    "Watermelon": {"cat": "Fruit", "mr": "Kalingad", "hi": "Tarbuj", "yield": 180, "beej": 5000, "khat": 6000, "aushad": 4000, "majdoor": 7000, "pani": 3000, "other": 1500},
    "Apple": {"cat": "Fruit", "mr": "Safarchand", "hi": "Seb", "yield": 80, "beej": 20000, "khat": 15000, "aushad": 10000, "majdoor": 12000, "pani": 5000, "other": 3000},
    "Soybean": {"cat": "Kharif", "mr": "Soyabean", "hi": "Soyabean", "yield": 10, "beej": 3000, "khat": 4000, "aushad": 3000, "majdoor": 5000, "pani": 1500, "other": 1500},
    "Cotton": {"cat": "Kharif", "mr": "Kapus", "hi": "Kapas", "yield": 12, "beej": 4000, "khat": 6000, "aushad": 7000, "majdoor": 6000, "pani": 2000, "other": 1000},
}
...
with tab1:
    if not st.session_state.edit_id:
        st.markdown(f"### {T['new']} ke liye dabao")
        ...
        if cat_display in ["All","Sarva","Sabhi"]: cat_eng="All"
...
with tab2:
    ...
    loc=st.text_input("Gaav", "Sindkhed, Maharashtra")
    c1,c2,c3=st.columns(3)
    c1.metric("Temp", "32 C")
    c2.metric("Humidity", "65%")
    c3.metric("Rain", "60%")
    st.info(f"{loc} - Aaj dhund, kal baarish")
    mandi_df = pd.DataFrame({"Crop":["Tomato","Onion","Dalimb","Santra"], "Bhav":[3500,2800,5000,4000]})
    st.table(mandi_df)
